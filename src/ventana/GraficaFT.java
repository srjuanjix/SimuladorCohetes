...
/**
 * Clase para dibujar graficas tipicas algo-tiempo
 */
public class GraficaFT extends Canvas
{
    ...
    /**
     * Constructor. Hace que el tamaño del canvas sea axb pixels.
     */
    public GraficaFT()
    {
...
// ....................................................................... eje horizontal
     ...
     for(int i=0; i<=15; i++){
          ...
          String str=String.valueOf(i/10); // System.out.println("imprimiendo i:"+i);
...
// ....................................................................... eje vertical
     ...
     g.drawString("F(N)", orgX+charAncho, charAlto);
     ...
     for(int i=0; i<=100; i+=10){
          ...
          String str=String.valueOf(i*3);  System.out.println("------> Pintando Numero (i,Y1)"+i+","+y1) ;
   ...
   // -----------------------------------------------------------------------------------------------------------   
      void pintaTrajectoria(Graphics g,int tTot)
     {
        ...
        int i, cnt=0 ;
        double escalaX=1, escalaY=2;
        double x1=0,x2=0,y1=0,y2=0 ;
        
        
        Line2D linea = new Double (origenX+x1, origenY-y1, origenX+x2, origenY-y2);
      
            for (i=0; i<tTot-2; i=i+1) {

                x1 = (escalaX * i)/0.1 ;  // /3
                x2 = (escalaX * i+1)/0.1 ;  // /3

                y1 = escalaY * this.empujeT[i] ;
                y2 = escalaY * this.empujeT[i+1] ;

                         
                cnt ++ ;

            // System.out.println("------> Datos (F (N),t)=("+y1+" (N),"+i+") ---> Pintando trayectoria (x1,y1)-(x2,y2)=("+(origenX+x1)+","+(origenY-y1)+")-("+(origenX+x2)+","+(origenY-y2)+")");
