 ...
 */
public class GraficaAT extends Canvas
{
...
// ....................................................................... eje vertical
     ...
     g.drawString("gs", orgX+charAncho, charAlto);
      ...
      void pintaTrajectoria(Graphics g,int tTot)
     {
        ...
        Line2D linea = new Double (origenX+x1, origenY-y1, origenX+x2, origenY-y2);
            ...
            for (i=0; i<tTot-2; i=i+20) {
                ...
                y1 = escalaY * this.aceleracionT[i] ;
                y2 = escalaY * this.aceleracionT[i+20] ;
